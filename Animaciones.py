...
def caminata():
    ...
    mover_servos([2,4,6,10,12,14], [inicial[2],inicial[4],inicial[6],inicial[10],inicial[12],inicial[14]],[maximos[2],maximos[4],maximos[6],maximos[10],maximos[12],maximos[14]],5)
    print("Parte 1- Hecho...")
    time.sleep(3)
    mover_servos([3,11,15],[maximos[3],maximos[11],inicial[15]],[minimos[3],minimos[11],inicial[15]],3)
    print("Cadera Corregida..")
    time.sleep(1)
    mover_servos([2,4,6,10,12,14],[maximos[2],maximos[4],maximos[6],maximos[10],maximos[12],maximos[14]],[minimos[2],minimos[4],minimos[6],minimos[10],minimos[12],minimos[14]],10)
    print("Parte 2- Hecho..")
    time.sleep(1)
    mover_servos([2,4,6,10,12,14],[minimos[2],minimos[4],minimos[6],minimos[10],minimos[12],minimos[14]],[inicial[2],inicial[4],inicial[6],inicial[10],inicial[12],inicial[14]],2)
    print("Parte 3- Hecho..")
    time.sleep(0.1)
    print("Finalizando..")
caminata()
